...
public class TextureComponent extends BaseComponent {
	...
	public TextureComponent(TextureReference reference) {
		this.texture = reference.texture;
		this.u = reference.u;
		this.v = reference.v;
		this.regionWidth = reference.width;
		this.regionHeight = reference.height;
		this.textureWidth = 256; // Default texture width
		this.textureHeight = 256; // Default texture width
	...
	public TextureReference reference() {
		return new TextureReference(this.texture, this.u, this.v, this.width, this.height);
	}

	public void reference(TextureReference reference) {
		this.texture = reference.texture;
		this.u = reference.u;
		this.v = reference.v;
		this.regionWidth = reference.width;
		this.regionHeight = reference.height;
		this.textureWidth = 256; // Default texture width
		this.textureHeight = 256; // Default texture height
	...
	public void draw(OwoUIDrawContext context, int mouseX, int mouseY, float partialTicks, float delta) {
		...
		context.drawTexture(this.texture, visibleArea.x(), visibleArea.y(), rightEdge - visibleArea.x(), bottomEdge - visibleArea.y(),
				this.u + visibleArea.x(), this.v + visibleArea.y(), rightEdge - visibleArea.x(), bottomEdge - visibleArea.y(),
